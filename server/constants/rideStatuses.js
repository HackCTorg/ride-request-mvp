...
const STATUS_CATEGORIES = {
  ...
  CANCELLATION: [RIDE_STATUSES.RIDE_CANCELED_BY_RIDE],
...
const CLOSING_STATUSES = [
  RIDE_STATUSES.RIDE_CANCELED_BY_RIDE,
...
const getStatusDescription = (status) => {
  const descriptions = {
    ...
    [RIDE_STATUSES.RIDE_CANCELED_BY_RIDE]: 'Ride Canceled by Ride',
...
const getNextValidStatuses = (currentStatus, isRoundTrip = false) => {
  const transitions = {
    [RIDE_STATUSES.REQUEST_IN_PROGRESS]: [RIDE_STATUSES.RIDE_CONFIRMED, RIDE_STATUSES.RIDE_CANCELED_BY_RIDE],
    [RIDE_STATUSES.RIDE_CONFIRMED]: [RIDE_STATUSES.RIDE_STARTED, RIDE_STATUSES.RIDE_CANCELED_BY_RIDE],
